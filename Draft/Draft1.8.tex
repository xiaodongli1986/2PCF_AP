...
\author{Xiao-Dong~Li$^{1,2,4}$, Cristiano G. Sabiu$^3$, Yuting Wang$^4$, Changbom~Park$^2$, Gong-bo Zhao$^4$, Hyunbae Park$^3$, Arman Shafieloo$^3$, Juhan Kim$^5$ and Sungwook E. Hong$^3$}
...
from the Alcock-Paczynski (AP) test via the redshift dependence of galaxy clustering on scales of 6 -- 40 $h^{-1}\rm Mpc$
