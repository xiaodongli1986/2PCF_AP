...
Addint our new AP measurements to the aforementioned results 
reduces the error bars by 30-40\%,
...
\begin{figure*}
   \centering{
   %\includegraphics[width=9cm,natwidth=4,natheight=4]{figCPL_a.pdf}
   \includegraphics[height=6cm,natwidth=6,natheight=4.5]{figCPL_b.pdf}
   %\includegraphics[width=5.5cm,natwidth=4,natheight=4]{figCPL_b_BAOSNIaAP.pdf}
   \includegraphics[height=6cm,natwidth=6,natheight=4.5]{figCPL_d.pdf}
