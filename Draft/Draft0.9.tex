...
This doubling of the figure of merit comes at no additional cost or alteration to survey design, 
...
We believe that the presented method of clustering shells will be applied to many spectroscopic galaxy surveys. 
The current figure of merit constraints on $(w_0, w_a)$ is increased by a factor of 2 
when considering the small scale clustering shells information in combination with existing constraints. 
The analysis we perform requires no change to the typical survey strategy of large cosmological redshift surveys, 
thus we can increasing (by roughly twice) the power of ongoing and future surveys, with little to no additional cost.
