...
reduced the 95.4\% CL $w_0-w_a$ contour by 51\%.
...
we adopt $\mu_{\rm max}=0.99$ to include more FoG effect,
decrease number of bins to $n_{\rm bin}=15-20$ to be more conservative,
change $s_{\rm max}$ to 35 or 45 $\rm Mpc/h$,
...
if we discard the systematic correction,
the shift in contour position is very small.
