...
\begin{figure*}
   \centering{
   \includegraphics[width=16cm]{fig_smu.eps}
...
\begin{figure*}
   ...
   \includegraphics[width=8cm,natwidth=6,natheight=4.5]{figCPL_d.pdf}
...
%This suggest that the CPL constraints reported are robust.
