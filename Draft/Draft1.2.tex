...
The Alcock-Paczynski (AP) test was performed via the redshift dependence of clustering on scales of 6-40 $h^{-1}\rm Mpc$.
We improve the methodology of \cite{Li2016} by significantly reducing its computation time. 
This enables us to efficiently explore three or more cosmological parameters.
...
\begin{figure*}
   ...
   Left panel: Mapping $\xi(s,\mu)$ from the fiducial cosmology to four other cosmologies. 
...
shift in contour position is not significant even when %we do not include the systematic correction.
